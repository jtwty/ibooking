    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="movie" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column v-bind="open" label="当前状态" align="center">
                    <template slot-scope="scope">
                ...
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-search"
                                   @click="handleCheck(scope.$index, scope.row)">查看座位</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
import { adminUpdateStudyroom, getAllStudyroom, getSeatInfo } from '../../api/index';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
        roomSearch() {
            getAllStudyroom(this.Rsearcher).then(res => {
        ...
        handleCheck(index, row) {
            //getSeat(this.scheduleID).then(res => {
